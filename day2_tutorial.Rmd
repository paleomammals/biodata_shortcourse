...
```{r}
require(geodata);require(dismo);require(maps)
```
...
points(transformlong(backgr[,"x"]),backgr[,"y"],col = "blue") #there they are
```
...
```{r}
load("climatelayers.RData", verbose = T)
```
...
data(wrld_simpl)
plot(wrld_simpl,axes = TRUE,col = "green", xlim = xrange, ylim = yrange,
